...
source.all.functions<-function(){
        ...
        source(paste0(main.code.folder,"\\_code_FUNCTION#2_read.norm.filt.data-v1.R"))
        source(paste0(main.code.folder,"\\_code_FUNCTION#3_QC.CDKN1A.PPIA.HPRT-v3.R"))
        ...
        source(paste0(main.code.folder,"\\_code_FUNCTION#12_plot.heatmap-v1.R"))
        source(paste0(main.code.folder,"\\_code_FUNCTION#13_heatmap.2.mod-v1.R")) 
}
