...
source(paste0(main.code.folder,"\\_code_FUNCTION#0__source.all.functions-v1-3.R"))
...
data.norm.filt<-read.norm.filt.data(writeGEO=TRUE,softTemplate="GPL6885.annot.gz")
